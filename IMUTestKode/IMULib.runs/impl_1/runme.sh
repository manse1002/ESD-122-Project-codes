...
HD_PWD='C:/Filer Vivado/IMULib_V2_Virker/IMULib.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mpu_rg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mpu_rg.tcl -notrace
