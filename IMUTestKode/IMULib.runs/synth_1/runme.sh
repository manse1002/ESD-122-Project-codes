...
HD_PWD='C:/Filer Vivado/IMULib_V2_Virker/IMULib.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mpu_rg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mpu_rg.tcl
